        ...
        Item
        {
                ...
                Switch
                {
                    ...
                    indicator: Image
                    {
                        ...
                        source: parent.checked ?
                                "qrc:/images/images/Settings/switch_on.png" :
                                "qrc:/images/images/Settings/switch_off.png"
            ...
            Rectangle
            {
                ...
                FunctionsBar
                {
                    ...
                    buttonCount: 3
                    buttonTexts: [qsTr("整车"), qsTr("前排"), qsTr("后排")]
